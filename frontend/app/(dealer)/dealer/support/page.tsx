...
export default function DealerSupportPage() {
  ...
  return (
    <div className="flex flex-col gap-6 pb-16">
      {/* Toast */}
      {toast && (
        <div className="fixed bottom-6 right-6 z-[9999] px-5 py-3 rounded-2xl bg-emerald-500/15 border border-emerald-500/30 text-emerald-400 text-sm font-semibold backdrop-blur-xl shadow-xl">
          {toast}
        </div>
      )}
