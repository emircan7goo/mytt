    ...
    <div className="min-h-screen bg-[var(--k-canvas-2)] py-12 px-4 lg:px-8">
      <div className="max-w-[900px] mx-auto bg-[var(--k-surface)] p-8 md:p-12 rounded-3xl border border-[var(--k-line)] shadow-sm space-y-8">
        <div className="flex items-center gap-4 border-b border-[var(--k-line)] pb-6">
          ...
          <div>
            <h1 className="text-3xl font-black text-[var(--k-ink)]">Güvenli Ödeme & Escrow Koruması</h1>
            <p className="text-sm text-[var(--k-ink-3)] font-medium">256-Bit SSL Şifreleme & Alıcı-Satıcı Havuz Hesabı</p>
          </div>
        </div>
        ...
        <div className="space-y-6 text-sm text-[var(--k-ink-2)] font-medium leading-relaxed">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-xs font-bold text-[var(--k-ink)]">
            ...
            <div className="p-4 bg-[var(--k-canvas-2)] rounded-2xl border border-[var(--k-line)] space-y-2">
              ...
              <p className="text-[var(--k-ink-2)] font-medium">Teslimat onayından sonra ödeme satıcının hesabına eksiksiz aktarılır.</p>
            </div>
          </div>
        </div>
      </div>
