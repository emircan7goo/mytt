...
export default function GizlilikPage() {
  return (
    <div className="min-h-screen bg-slate-50 py-12 px-4 lg:px-8">
      <div className="max-w-[900px] mx-auto bg-white p-8 md:p-12 rounded-3xl border border-slate-200 shadow-sm space-y-6">
        ...
        <div className="space-y-4 text-sm text-slate-600 font-medium leading-relaxed">
          ...
          <h3 className="text-base font-black text-slate-900 pt-2">1. Veri Sorumlusu</h3>
          <p>
          ...
          <h3 className="text-base font-black text-slate-900 pt-2">2. İşlenen Kişisel Veriler ve Amacı</h3>
          <p>
          ...
          <h3 className="text-base font-black text-slate-900 pt-2">3. Veri Güvenliği ve Escrow Koruması</h3>
          <p>
          ...
          <h3 className="text-base font-black text-slate-900 pt-2">4. İletişim</h3>
          <p>
