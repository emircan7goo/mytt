    ...
    <main className="min-h-screen bg-[#F8FAFC] pt-[100px] pb-20">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="prose prose-zinc max-w-none space-y-8 text-zinc-700 text-[15px] leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-zinc-900 mb-3">Çerez Nedir?</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-zinc-900 mb-3">Kullandığımız Çerezler</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-zinc-900 mb-3">Zorunlu Çerezler</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-zinc-900 mb-3">Analitik Çerezler</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-zinc-900 mb-3">Çerez Tercihlerinizi Yönetin</h2>
            <p>
            ...
            <ul className="list-disc pl-5 space-y-1 mt-2">
              <li><a href="https://support.google.com/chrome/answer/95647" target="_blank" rel="noopener" className="text-zinc-900 underline underline-offset-2">Chrome</a></li>
              <li><a href="https://support.mozilla.org/tr/kb/cerezleri-silme" target="_blank" rel="noopener" className="text-zinc-900 underline underline-offset-2">Firefox</a></li>
              <li><a href="https://support.apple.com/tr-tr/105082" target="_blank" rel="noopener" className="text-zinc-900 underline underline-offset-2">Safari</a></li>
            </ul>
          </section>
