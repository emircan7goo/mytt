    ...
    <main className="min-h-screen bg-[#F8FAFC] pt-[100px] pb-20">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <div className="prose prose-zinc max-w-none space-y-8 text-zinc-700 text-[15px] leading-relaxed">
          ...
          <section>
            <h2 className="text-lg font-semibold text-zinc-900 mb-3">1. Hizmetin Kapsamı</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-zinc-900 mb-3">2. Kullanıcı Hesabı</h2>
          ...
          <section>
            <h2 className="text-lg font-semibold text-zinc-900 mb-3">3. Ödeme ve Güvence</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-zinc-900 mb-3">4. Bayi Yükümlülükleri</h2>
            <ul className="list-disc pl-5 space-y-2">
          ...
          <section>
            <h2 className="text-lg font-semibold text-zinc-900 mb-3">5. Yasaklı Faaliyetler</h2>
            <ul className="list-disc pl-5 space-y-2">
          ...
          <section>
            <h2 className="text-lg font-semibold text-zinc-900 mb-3">6. Fikri Mülkiyet</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibent text-zinc-900 mb-3">7. Sorumluluk Sınırlaması</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-zinc-900 mb-3">8. Hesap Askıya Alma ve Kapatma</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-zinc-900 mb-3">9. Uygulanacak Hukuk</h2>
            <p>
          ...
          <section>
            <h2 className="text-lg font-semibold text-zinc-900 mb-3">10. Değişiklikler</h2>
            <p>
