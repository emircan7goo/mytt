                ...
                filtered.map((dealer: any) => (
                  <tr key={dealer.id} className="hover:bg-slate-50/50 transition-colors group">
                    ...
                    <td className="px-6 py-4 text-right">
                      <span className="inline-flex items-center gap-1.5 px-3 py-1 bg-orange-50 text-orange-700 font-black rounded-lg border border-orange-100/50 text-base">
            ...
            <form onSubmit={handleUpdate} className="p-6 space-y-6">
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  >
                    <div className={`p-2 rounded-full ${mode === 'add' ? 'bg-orange-100' : 'bg-slate-100'}`}>
                      <Plus size={16} />
                    </div>
