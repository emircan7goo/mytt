...
export function ProductCardSkeleton() {
  return (
    <div className="bg-white rounded-3xl border border-zinc-100 w-full overflow-hidden shadow-sm">
  ...
  return (
    ...
    >
      <Link href={`/product/${product.id}`} className="block h-full">
        <div
          className="h-full flex flex-col bg-white rounded-xl overflow-hidden transition-colors duration-300 border border-slate-100 tilt-card relative"
          style={{
            ...tiltStyle,
        ...
        >
          ...
          />
          {/* ── Image ── */}
          <div className="relative overflow-hidden bg-slate-50 product-card-shine" style={{ aspectRatio: '1.05/1' }}>
            <SafeImage
              ...
              fallbackIcon={<Smartphone size={32} className="opacity-10 text-slate-400" />}
            />
            ...
            <button
              ...
              className={`absolute bottom-2.5 right-2.5 w-7 h-7 rounded-full flex items-center justify-center transition-all bg-white shadow-sm border border-slate-100 ${
          ...
          {/* ── Content ── */}
          <div className="flex flex-col flex-1 p-3.5 gap-1 bg-white">
