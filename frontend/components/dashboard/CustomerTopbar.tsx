    ...
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
        ...
        <button style={{
          ...
          <Bell size={14} />
          <div style={{ position: 'absolute', top: '7px', right: '7px', width: 6, height: 6, borderRadius: '50%', background: '#10b981' }} />
        </button>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', padding: '5px 10px 5px 5px', borderRadius: '10px', background: 'rgba(15,23,42,0.04)', border: '1px solid rgba(15,23,42,0.07)' }}>
          {user?.avatar ? (
            ...
            <div style={{ width: 26, height: 26, borderRadius: '7px', background: '#10b981', display: 'flex', alignItems: 'center', justifyContent: 'center', color: 'white', fontSize: '11px', fontWeight: 700 }}>
              {user?.name?.charAt(0)}
            </div>
          )}
