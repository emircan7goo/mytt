        ...
        <div className="h-full flex flex-col bg-[var(--k-surface)] rounded-2xl border border-[var(--k-line)] overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_12px_40px_rgba(0,0,0,0.10)] hover:border-[var(--k-line)]">
          ...
          >
            ...
            {battery !== null && battery !== undefined && (
              <div className="absolute bottom-3 right-3 z-10 flex items-center gap-1 bg-[rgba(251,249,246,0.90)] backdrop-blur-sm border border-[var(--k-line-2)] rounded-full px-2 py-0.5 text-[10px] font-bold text-[var(--k-ink-2)] shadow-sm">
                <Battery
                  size={10}
                  className={battery >= 85 ? 'text-[var(--k-hot)]' : battery >= 70 ? 'text-[var(--k-hot)]' : 'text-red-400'}
                />
                %{battery}
              </div>
            )}
            ...
            <button
              ...
              className="absolute top-3 right-3 z-20 w-8 h-8 flex items-center justify-center rounded-full bg-[rgba(251,249,246,0.90)] backdrop-blur-sm border border-[var(--k-line-2)] shadow-sm transition-all duration-200 hover:scale-110 hover:bg-[var(--k-surface)]"
