      ...
      <div className="bg-[var(--k-canvas)] border border-[var(--k-line)] shadow-2xl rounded-3xl p-8 md:p-12 text-white relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {FEATURES.map((f, i) => {
            const Icon = f.icon;
            return (
              <div key={i} className="bg-[var(--k-void)] p-6 rounded-2xl border border-[var(--k-line)]/80 shadow-md hover:border-orange-500/60 hover:-translate-y-1 transition-all duration-300 space-y-4">
