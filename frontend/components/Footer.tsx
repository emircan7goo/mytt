      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-8">
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-6 mb-10 pb-8 border-b border-[var(--k-line)]">
          <Link href="/" className="flex items-center gap-4 group selection:bg-transparent">
            <span className="font-black text-3xl sm:text-4xl tracking-tighter text-white flex items-center select-none">
              m<span className="text-[var(--k-hot)] drop-shadow-[0_0_12px_rgba(255,96,0,0.75)]">y</span>tt
            </span>
          </Link>
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 mt-8 md:mt-0 text-[var(--k-ink-3)] text-[12px] font-bold uppercase tracking-widest">
            <div className="flex items-center gap-6 opacity-60 hover:opacity-100 transition-opacity">
              <span className="flex items-center gap-2 text-[var(--k-ink-2)]">
                <ShieldCheck size={20} strokeWidth={2} className="text-[var(--k-hot)]" /> %100 Orijinal
              </span>
              <span className="flex items-center gap-2 text-[var(--k-ink-2)]">
                <ShieldCheck size={20} strokeWidth={2} className="text-[var(--k-hot)]" /> Alışveriş Güvencesi
              </span>
              <span className="flex items-center gap-2 text-[var(--k-ink-2)]">
                <ShieldCheck size={20} strokeWidth={2} className="text-[var(--k-hot)]" /> 256-Bit SSL
              </span>
                  ...
                  return (
                    <li key={i}>
                      <Link
                        ...
                        className="block text-[14px] font-medium text-[var(--k-ink-2)] hover:text-[var(--k-hot)] hover:translate-x-1 transition-all"
                      >
                        {link}
                      </Link>
                    </li>
        ...
        <div className="rounded-[12px] p-5 md:p-6 flex flex-col md:flex-row items-stretch gap-4 mb-8" style={{ background: 'var(--k-surface)', border: '1px solid var(--k-line)' }}>
          ...
          <div className="flex items-center gap-4 flex-1 min-w-0 group p-2">
            <div className="w-11 h-11 flex-shrink-0 rounded-[9px] flex items-center justify-center bg-[var(--k-hot-wash)] border border-[var(--k-line-hot)]">
              <Phone size={18} strokeWidth={2} className="text-[var(--k-hot)]" />
            </div>
            <div className="min-w-0">
              <p className="k-label mb-1.5">Müşteri Hattı (7/24)</p>
              <a href="tel:+908503080000" className="text-[var(--k-ink)] font-extrabold text-[16px] hover:text-[var(--k-hot)] transition-colors truncate block">0850 308 00 00</a>
            </div>
          </div>
          ...
          <div className="flex items-center gap-4 flex-1 min-w-0 group p-2">
            <div className="w-11 h-11 flex-shrink-0 rounded-[9px] flex items-center justify-center bg-[var(--k-hot-wash)] border border-[var(--k-line-hot)]">
              <Mail size={18} strokeWidth={2} className="text-[var(--k-hot)]" />
            </div>
            <div className="min-w-0">
          ...
          <div className="flex items-center gap-4 flex-1 min-w-0 group p-2">
            <div className="w-11 h-11 flex-shrink-0 rounded-[9px] flex items-center justify-center bg-[var(--k-hot-wash)] border border-[var(--k-line-hot)]">
              <MapPin size={18} strokeWidth={2} className="text-[var(--k-hot)]" />
            </div>
            <div className="min-w-0">
        ...
        <div className="pt-6 flex flex-col md:flex-row items-center justify-between gap-4 text-[13px] font-medium" style={{ borderTop: '1px solid var(--k-line)' }}>
          ...
          <div className="flex items-center gap-6 flex-wrap justify-center">
            <Link href="/kvkk" className="text-[var(--k-ink-3)] hover:text-[var(--k-hot)] transition-colors font-semibold">KVKK</Link>
            <Link href="/kullanim-kosullari" className="text-[var(--k-ink-3)] hover:text-[var(--k-hot)] transition-colors font-semibold">Kullanım Koşulları</Link>
            <Link href="/cerez-politikasi" className="text-[var(--k-ink-3)] hover:text-[var(--k-hot)] transition-colors font-semibold">Çerez Politikası</Link>
            <Link href="/gizlilik" className="text-[var(--k-ink-3)] hover:text-[var(--k-hot)] transition-colors font-semibold">Gizlilik Politikası</Link>
            <Link href="/sozlesmeler" className="text-[var(--k-ink-3)] hover:text-[var(--k-hot)] transition-colors font-semibold">Sözleşmeler ve Formlar</Link>
          </div>
        </div>
      </div>
    </footer>
